...
<div class="pageContent">
	...
	<form method="post" action="manage/city/saveOrUpdate.do" class="pageForm required-validate" onsubmit="return validateCallback(this ,navTabAjaxDone)">
		<input type="hidden" value="${action}" name="action"/>
		<div class="pageFormContent nowrap" layoutH="56">

			<fieldset>
			<legend id="addtype">市级代码操作</legend>
			<dl>
				<dt>名称：</dt>
				<dd>
				<input type="hidden"  value="${city.cityId}" name="cityId">
				<input type="text"  class="required" value="${city.cityName}" name="cityName">
				</dd>
			</dl>
			<dl>
				<dt>选择省份</dt>
