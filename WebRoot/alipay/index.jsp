...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
		...
		<form name=alipayment action="alipay/pay.action" method=post>
			<input size="40" name="orderId" value="2015102001000001236229" hidden="true" />
			<input size="30" name="orderType" value="100" hidden="true" />
